...
interface Props extends SVGProps {
  onChange: (checked: boolean, ev: React.MouseEvent<SVGSVGElement, MouseEvent>) => void;
  checked: boolean;
...
const DarkModeSwitch = React.forwardRef<SVGSVGElement, Props>(
  (
    ...
    const toggle = (ev: React.MouseEvent<SVGSVGElement, MouseEvent>) => onChange(!checked, ev);
